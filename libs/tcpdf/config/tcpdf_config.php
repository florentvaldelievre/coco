...
if (!defined("K_TCPDF_EXTERNAL_CONFIG")) {
	 ...
	 * url path
	 */
	define ("K_PATH_URL", "http://localhost/chartercar/libs/tcpdf/");
	 ...
	 * header title
	 */
	define ("PDF_HEADER_TITLE", "www.waybus.com");
	
	/**
	 * header description string
	 */
	define ("PDF_HEADER_STRING", "33 rue de coulanges\n94370\nSucy-en-brie\n");
	
	/**
	 * image logo
	 */
	define ("PDF_HEADER_LOGO", "logo_transparent.png");
