...
/**
  ...
  *
  * $Id: hn_captcha.class.php5,v 1.6 2007/12/23 23:20:10 horst Exp $
  *
...
class hn_captcha
{
    ...
    //
        ...
        public function __construct($config, $debug=FALSE, $secure=TRUE)
        {
            ...
            $this->messages = array(
                ...
                'fr'=>array(
                            'msg1'=>'Vous devez lire et saisir les <b>'.$this->chars.'Caractères</b> présent dans l\'image ci-dessus (<b>0..9</b> et <b>'.$usedchars.'</b>), dans le champ ci-dessous <br> et valider le formulaire.',
                            'msg2'=>'Caracteres illisibles?',
                            'buttontext'=>'valider',
                            'refreshbuttontext'=>'re-generer l\'image'
                            ),
                'it'=>array(
    ...
    //
        ...
        private function notvalid_msg()
        {
            ...
            // invalid try's: fr
            if($this->lang == "fr" && $this->current_try > 2 && $this->refreshlink) return $this->sanitized_output('Saisie non valide. Veuillez essayer à nouveau');
            if($this->lang == "fr" && $this->current_try >= 2) return $this->sanitized_output('Saisie non valide. Veuillez essayer à nouveau');
